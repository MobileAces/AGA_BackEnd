...
public class TeamMemberDeleteResponse {
    ...
    private TeamMemberDeleteResponseDTO data;

    //생성 메소드//
    public static TeamMemberDeleteResponse teamMemberDeleteResponseCreate(String message, Integer code, TeamMemberDeleteResponseDTO data){
